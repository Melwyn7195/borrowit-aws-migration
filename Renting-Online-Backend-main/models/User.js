...
async function updateUser(userId, userData) {
  // Filter out undefined values and accept both camelCase and snake_case
  const updates = {};
  ...
  if (userData.email_verified !== undefined) updates.email_verified = userData.email_verified;
